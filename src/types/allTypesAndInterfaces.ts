...
export interface LayerContextType {
  ...
  isChangingOpacityField: boolean;
  changePopulationSettings: (field?: string, color?: string) => Promise<void>;
  changeIncomeSettings: (field?: string, color?: string) => Promise<void>;
  changeRealEstateSettings: (field?: string, color?: string) => Promise<void>;
...
export interface IntelligenceViewport {
  ...
  income_field?: string;
  real_estate_field?: string;
  population_color?: string;
  income_color?: string;
  real_estate_color?: string;
}

export interface IntelligenceViewportResponse {
  features: Feature[];
  metadata?: {
    color?: string;
    layer_color?: string;
    ...
    property_color_options?: Array<{ property: string; color: string }>;
    [key: string]: unknown;
  };
